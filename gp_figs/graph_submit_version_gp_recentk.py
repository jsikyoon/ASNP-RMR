...
dirs_a = [
    ...
    '../logs_gp_a/11-11,18:17:46.241572',  # ASNPwoImg(K=3)
    '../logs_gp_a/11-11,18:16:58.774438',  # ASNPwoImg(K=5)
    '../logs_gp_a/11-11,18:59:57.248192',  # ASNPwoImg(K=inf)
    ]
...
dirs_b = [
    ...
    '../logs_gp_b/11-11,19:00:33.852374',  # ASNPwoImg(K=3)
    '../logs_gp_b/11-11,18:16:46.436511',  # ASNPwoImg(K=5)
    '../logs_gp_b/11-11,18:16:48.435383',  # ASNPwoImg(K=inf)
     ]
...
dirs_c = [
    ...
    '../logs_gp_c/11-11,18:17:58.070309',  # ASNPwoImg(K=3)
    '../logs_gp_c/11-11,18:17:44.161261',  # ASNPwoImg(K=5)
    '../logs_gp_c/11-11,18:17:54.618255',  # ASNPwoImg(K=inf)
     ]
...
ax1.set_title('Scenario (a)'+', '+str(int(min_iter_a/1000))+'K', fontsize=20)
...
ax2.set_title('Scenario (b)'+', '+str(int(min_iter_b/1000))+'K', fontsize=20)
...
#plt.ylabel('Target NLL',fontsize=14)
#legend = plt.legend(bbox_to_anchor=(0.08, 0.99), title="Model (setting)", loc=2, ncol=1, fontsize=14)
legend = ax3.legend(bbox_to_anchor=(0.48, 1.02), title="Model", loc=2, ncol=1, fontsize=10)
#plt.setp(legend.get_title(),fontsize=19)
#ax2.setp(legend.get_title(),fontsize=14)
ax3.set_title('Scenario (c)'+', '+str(int(min_iter_c/1000))+'K', fontsize=20)
