...
dirs_a = [
    ...
    '08-20,10:47:46.517091', #SNP(h=128)
    '01-19,19:48:35.169591', #SNPK(h=128, K=9)
    '01-14,18:41:04.666931', #SNPK(h=128, K=25)
    '01-09,11:14:57.894510', #SNPK(h=128, K=100)
    '12-27,16:00:02.906900', #SNPK(h=128, K=inf)
    '01-15,08:55:00.395882', #ASNP(h=128, K=9)
    '08-20,10:47:50.746654', #ASNP(h=128, K=25)
    '01-09,11:15:43.832438', #ASNP(h=128, K=100)
    ]
...
dirs_b = [
    ...
    '01-28,13:09:54.387713', #SNP(h=1024)
    '01-09,11:01:38.252560', #SNPK(h=128, K=9)
    '01-09,11:01:52.198476', #SNPK(h=128, K=25)
    '01-09,11:01:48.599753', #SNPK(h=128, K=100)
    '12-28,08:10:36.113834', #SNPK(h=128, K=inf)
    '01-09,11:11:53.921534', #ASNP(h=128, K=9)
    '10-22,14:34:48.947854', #ASNP(h=128, K=25)
    '01-09,11:11:51.872909', #ASNP(h=128, K=100)
     ]
...
for d_idx, dir_name in enumerate(dirs_a):
    ...
    if k_printing:
        ...
        tnll = out['TargetNLL/Nll']
        print('task a',labels[d_idx])
        print(np.mean(tnll[-1*smoothing:]))
